...
class RabbitMQBroker:
    ...
    async def publish_message(
        self, message: AgentMessage, routing_key: str = "", exchange: str = None
    ):
    ...
    async def setup_consumer(
        self, agent_id: str, agent_type: AgentType, message_handler: Callable
    ):
    ...
    async def health_check(self) -> bool:
        ...
        try:
            ...
            self.channel.queue_declare(
                queue="health_check_temp", exclusive=True, auto_delete=True
            )
            return True

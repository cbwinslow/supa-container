...
class OrchestratorBrain:
    ...
    def __init__(self, broker: RabbitMQBroker, orchestrator_id: str = None):
        ...
        self.consumer = MessageConsumer(
            broker, self.orchestrator_id, AgentType.ORCHESTRATOR
        )
    ...
    def _setup_message_handlers(self):
        ...
        self.consumer.register_handler(
            MessageType.AGENT_REGISTRATION, self._handle_agent_registration
        )
        self.consumer.register_handler(
        ...
        self.consumer.register_handler(
            MessageType.METRICS_DATA, self._handle_metrics_data
        )
    ...
    async def _handle_log_data(self, message: AgentMessage):
        ...
        await self.data_analyzer.process_log_data(
            agent_id=message.sender_id, log_data=log_data
        )
            ...
            try:
                ...
                if total_data > 0:
                    ...
                    if efficiency < self.data_efficiency_threshold:
                        logger.warning(
                            f"Data efficiency below threshold: {efficiency:.2%}"
                        )
